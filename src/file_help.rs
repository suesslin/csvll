...
pub fn create_file(direc: String, name: String, extension: String) -> File {
...
pub fn open_file(direc: String, name: String, extension: String) -> File {
...
pub fn write_to_file(file: &mut File, content: &String) {
...
pub fn delete_file(direc: String, name: String, extension: String) {
